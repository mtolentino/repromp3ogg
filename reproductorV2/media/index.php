...
/*if ($id==0){
$sql=mysql_query("SELECT * FROM cancion where idlbum=1 ",$con);
...
{
$sql=mysql_query("SELECT * FROM cancion where idlbum=$id ",$con);
...
//echo '<script type="text/javascript" src="reproductor.js"></script>';
}
...
?>
			...
			<br>
				<div id='infobar'>
					<label id="lblCancion"><strong><img src="media/img/CC.png" width='12px'height='12px'> <span id='namecan'>-</span></strong></label>
				<div id="divProgreso">
					<div id="divBarra"></div>
					</div>
				...
				<div id="divInfo">
					...
					<div id="divLogo">
						<img id='logo'src="media/audio/moldo/cicatrices/logo.jpg" align="left">
					</div>
					<div id="divInfoCancion">
						
						<label id="lblArtista"><img src="media/img/ZX.png" width="15px"heigth="15px">&nbsp;<strong><span>-</span></strong> </label>
						<label id="lblalbum"><img src="media/img/AL.png" width="12px"heigth="12px">&nbsp;<span>Cicatrices</span></label>
						<label id="lblano"><img src="media/img/fe.png" width="12px"heigth="12px">&nbsp;<span>1997</span></label>
		...
		<script type="text/javascript" src="media/js/ext/jquery-1.7.2.min.js"></script>
...
///////////////////////////////////////////////////////////////////	///pausar valora PLUs enjoy

	//pausar o continuar la reproduccion
	$('#valora').on('click',function(){
